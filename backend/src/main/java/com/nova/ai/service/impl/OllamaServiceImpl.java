...
public class OllamaServiceImpl implements OllamaService {
    ...
    public OllamaServiceImpl(ChatHistoryRepository chatHistoryRepository,
    ...
    private String buildChatPayload(User user, ChatHistory chat, boolean isStream, List<String> available) throws Exception {
        ...
        // Auto-resolve model if not installed in Ollama
        ...
        // Add history (limit last 20 messages for context window stability)
